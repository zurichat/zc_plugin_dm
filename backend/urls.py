...
urlpatterns = [
    ...
    path("api/v1/rooms/<str:room_id>/messages", views.send_message, name="send_message"),
    path(
        "api/v1/rooms/<str:room_id>/messages/<str:message_id>/threads",
    ...
    path(
        "api/v1/copymessagelink/<str:message_id>",
    ...
    path(
        "api/v1/<str:room_id>/bookmark/new", views.save_bookmark, name="create_bookmark"
    ),
    path(
        "api/v1/get_organization_members",
        views.organization_members,
        name="organization_members",
    ),
    path(
        "api/v1/<str:room_id>/bookmark/all",
        views.retrieve_bookmarks,
        name="get_bookmarks",
    ),
    path("api/v1/<str:message_id>/read/new/", views.mark_read, name="mark_read"),
    path(
        "api/v1/<str:message_id>/pinnedmessages/new",
        views.pinned_message,
        name="pinned_message",
    ),
    path(
        "api/v1/<str:message_id>/deletepinnedmessage/",
        views.delete_pinned_message,
        name="pinned_message",
    ),
    path(
        "api/v1/<str:room_id>/<str:message_id>/pinnedmessage/",
        views.read_message_link,
        name="read_pinned_message",
    ),
    path(
        "api/v1/<str:room_id>/filter_messages",
    ...
    path(
        "api/v1/rooms/<str:room_id>/messages/<str:message_id>/reactions",
        views.Emoji.as_view(),
