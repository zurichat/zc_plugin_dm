<template >
    <div class=" userContainer  shadow  bg-white" >
          ...
          <div class="px-3">
            ...
            <div style="font-size:22px"><b>{{userData.displayName}}</b></div>
            <div style="font-size:12px">
                {{userData.profession}}<br>
                {{userData.gender}}
                <div class="mt-4"> <a href="/" class="text-decoration-none">View Full Profile</a></div>
          </div>
     ...
     <div  class="text-muted" >
           ...
           <div style="margin:26.18px 0 27px 0;  font-size:12px">
            ...
            <div class="d-flex justify-content-between mb-3 popup_footer">
                <b-button  size="sm" variant="outline-secondary" class="lh-1">Message</b-button>
                <b-button size="sm" variant="outline-secondary" class="lh-1">Mute</b-button>
            </div>
