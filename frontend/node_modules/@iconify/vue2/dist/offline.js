(function (global, factory) {
	...
	icon) => {
	            ...
	            default:
	                if (customisationAliases[key] !== void 0) {
	                    ...
	                    if (customisationAliases[key].boolean &&
	                        (value === true || value === 'true' || value === 1)) {
	                        // Check for boolean
	                        customisations$1[customisationAliases[key].attr] = true;
	                    }
	                    else if (!customisationAliases[key].boolean &&
	                        typeof value === 'string' &&
	                        value !== '') {
	                        // String
	                        customisations$1[customisationAliases[key].attr] = value;
	                    }
	                }
	    ...
	    const data = {
	        ...
	        domProps: {
	            innerHTML: id.replaceIDs(item.body, id$1 ? () => id$1 + '-' + localCounter++ : 'iconify-vue-'),
	        },
	    };
	...
	const Icon = Vue__default['default'].extend({
	    ...
	    render(createElement) {
	        ...
	        return render(createElement, props, this.$data, icon$1);
	    },
	});
