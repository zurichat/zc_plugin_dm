...
const DmfullProfile = ()=>{
    ...
    return(
        <div className="DmfullProfile">
            <div className="profile-picture" style={{ backgroundImage: 'url("https://res.cloudinary.com/ds5l1k3bl/image/upload/v1629593472/user_scepnk.jpg")'}}></div>
            ...
            <div className="profile-buttons">
                ...
                <div className="btn">
                    <img className="btn-icon" onClick={()=>toggleMoreOptions()} src={moreOptionsOpen?more2 :more}/>
                    <p>More</p>
                </div>
                { moreOptionsOpen &&
