  ...
  return (
    <>
      <div className="Dm-ThreeDotKebab-Menu-FirstPopup">
        ...
        <div onClick={() => setdmdeletepopup(!dmdeletepopup)}> Delete Message <FaTrashAlt /> </div>
     ...
     <div>In 3 hours</div>
        ...
        <div className="Dm-ThreeDotKebab-DeleteMessage">
          ...
          <button onClick={() => setdmdeletepopup(false)}>Cancel</button>  <button onClick={() => OnDeleteMessage()}>Confirm</button>
        </div>
        </div>
      )
}
