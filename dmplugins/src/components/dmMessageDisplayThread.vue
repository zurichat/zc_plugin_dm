        ...
        <div class="usertext-messages">
          <h5 class="pb-2">
            ...
            <span
              ...
              >MamaGee</span
            >
            <span class="msgTime"> 5:55 PM </span>
          </h5>
          <div
...
export default {
  ...
  mounted() {
    ...
    this.$store.state.replyThreadMsgs.clickedMsg =
      this.$refs.msgThreadUserMsg.textContent;
    this.$store.state.replyThreadMsgs.username =
      this.$refs.msgThreadUsername.textContent;
  },
  created() {
    this.fetchMessages();
    this.fetchEmojis();
